...
# ============================================================
# BỔ SUNG: Hàm cleaning (thêm vào, không thay đổi logic chính)
# ============================================================
EXCLUDE_COLS = {
    "location", "geometry", "wkt", "border", "shape",
    "point", "polygon", "wkb", "st_astext"
}
...
print(f"[INFO] Bắt đầu pipeline cho {silver_table}")
...
if not spark.catalog.tableExists(silver_table):
    ...
    df_silver_active = (
        ...
        .filter(F.col("_rn") == 1)   # Giữ nguyên như gốc, không lọc deleted_audit_ts
