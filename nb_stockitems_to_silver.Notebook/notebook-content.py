...
# ============================================================
# DEDICATED SILVER NOTEBOOK — WAREHOUSE_STOCKITEMS (FULL LOAD)
# ============================================================
...
# Hardcode
TARGET_OBJECT = "Warehouse_StockItems"
...
hash_expr = [F.coalesce(F.col(c).cast("string"), F.lit("NULL")) for c in business_columns]
